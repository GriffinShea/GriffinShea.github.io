...
<div class="row">
	<div class="column">
		...
		<ul>
			...
			<li>Four-stage collision detection algorithm using a k-d tree, axis-aligned bounding boxes, <a href="https://caseymuratori.com/blog_0003">GJKSM</a> intersection tests to confirm collisions, and expanding polytope algorithm to find and return collision artefacts</li>
	...
	<div class="column">
		<iframe width="480px" src="https://www.youtube.com/embed/4wh63CocHC8?controls=0&autoplay=1&fs=1" allowfullscreen></iframe>
